      ...
      <div className="w-full max-w-md rounded-4xl border border-slate-200 bg-white p-6 shadow-2xl">
        ...
        <div className="mt-6 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
          ...
          <button
            ...
            onClick={onConfirm}
            disabled={loading}
            className="rounded-2xl bg-rose-600 px-5 py-3 text-sm font-medium text-white transition hover:bg-rose-500 disabled:cursor-not-allowed disabled:opacity-60"
          >
